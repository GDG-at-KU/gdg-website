...
function MemberPass({ member }: { member: GdgMember }) {
  return <main className={"member-page"}>
    ...
    <section className={"member-hero"}>
      <div><p className={"member-eyebrow"}>YOUR GDG KU PASS</p><h1>Carry the<br /><i>community.</i></h1><p className={"member-intro"}>Your verified KU email is connected to this phone. Scan in at events without filling out a form again.</p></div>
