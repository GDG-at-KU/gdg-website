...
export function BuddyMatch({ member }: { member: GdgMember }) {
  ...
  return <main className="buddy-page">
    <nav className="member-nav buddy-nav site-header"><a href="/" className="member-brand">GDG <span /> <em>ON CAMPUS<br />KU</em></a><div className="member-nav-actions"><a className="member-admin-link" href="/members">Directory</a><MemberSignOut /></div><SectionMenu /></nav>
